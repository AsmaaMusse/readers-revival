...
//create a function which creates a pop up of bulma box
//render that box on to the page
const renderPopup = function () {};

const popUpCard = document.getElementById("pop-up");
let constructPopUpCard = document.createElement("div"[
