const book = {
  ...
  volumeInfo: {
    ...
    language: "en",
    previewLink:
      "http://books.google.co.uk/books?id=eq9XvgAACAAJ&dq=harrypotter&hl=&cd=1&source=gbs_api",
    infoLink:
      "http://books.google.co.uk/books?id=eq9XvgAACAAJ&dq=harrypotter&hl=&source=gbs_api",
    canonicalVolumeLink:
